...
\begin{figure}[h]
    \centering
    \begin{subfigure}[b][][t]{10cm}
        \centering
        \begin{tikzpicture}
            \draw[step=0.5,gray,thin] (0,0) grid (6.75,2);
            \draw[thick, ->] (0,0) -- ++(6.75,0) node[below right] {$\texttt{M}_C$ in \si{\celsius}};
    ...
    \begin{subtable}[b][][t]{5cm}
        ...
        \label{tab:pcl}
    \end{subtable}
    \caption[Applikations \acrshort{lut} Beispiel]{Applikations \acrshort{lut} Beispiel.}
\end{figure}
