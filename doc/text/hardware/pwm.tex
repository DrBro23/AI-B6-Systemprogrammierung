...
Um deren Widerstandswert einzustellen müssen zwei Bytes sequentiell über \gls{spi} gesendet werden.
...
Die resultierenden Widerstände können mit \autoref{eq:resistance1} und \autoref{eq:resistance2} berechnet werden.
...
\begin{figure}
    ...
    \end{tikzpicture}
    \caption{NE555 Timer in PWM Konfiguration.}
    \label{fig:ne555-pwm}
\end{figure}
...
\begin{figure}[h]
    ...
    \begin{subfigure}{0.4\textwidth}
        \centering
        \includegraphics[width=4cm]{./img/noctua-1.jpg}
    \end{subfigure}
    \begin{subfigure}{0.4\textwidth}
        \centering
        \includegraphics[width=4cm]{./img/noctua-2.jpg}
    \end{subfigure}
