...
\lstinputlisting[firstnumber=17, firstline=17,lastline=27, language=C, caption={\texttt{./driver/src/temp.c:17-27}}, label=code:i2c-init]{../../driver/src/temp.c}

\Gls{i2c} Adapter De-initialisieren.
\lstinputlisting[firstnumber=29, firstline=29,lastline=34, language=C, caption={\texttt{./driver/src/temp.c:29-34}}, label=code:i2c-deinit]{../../driver/src/temp.c}
...
\begin{equation}
    \begin{aligned}
        \Delta_{\texttt{M}_D} &= \left|\frac{\texttt{M}_D}{16\si{\celsius}} - \left\lfloor\frac{\texttt{M}_D}{16\si{\per\celsius}}\right\rfloor\right| \\[2ex]
        \delta_{\texttt{M}_D} &= \left|\frac{\Delta_{\texttt{M}_D}}{\frac{\texttt{M}_D}{16\si{\celsius}} }\right| \\[2ex]
    \end{aligned}
    \label{eq:temp-error}
\end{equation}
\begin{figure}
...
\lstinputlisting[firstnumber=37, firstline=37,lastline=49, caption=\texttt{./driver/src/temp.c:37-49}, label=code:i2c-convert]{../../driver/src/temp.c}
