...
Die Pulsweite ist proportional zur resultierenden Ziel Geschiwindigkeit.
...
Das erste Stellt das Command-Byte dar.
Das zweite die tatsächlichen Daten.
...
Dieser benötigt eine Gleichspannung von $5\si{\volt}$ und wird mit einem \gls{pwm} Signal mit einer Amplitude von $5\si{\volt}$.
